...
router.get("/namedamola", function (req, res, next) {
  res.render("viewdamola", {
    name: "Adedamola",
    nickname: "Toyibah",
    qualities: ["Smart", "Hijabi", "Computer Science"],
  });
});
...
router.get("/nameebuka", function (req, res, next) {
  res.render("viewebuka", {
    name: "Ebuka",
    qualities: ["Dark", "Backend engineer", "Art lover", "Anime"],
  });
});
...
router.get("/nameEkene", function (req, res, next) {
  res.render("viewEkene", {
    name: "Ekene",
    nickname: "Shizuo",
    likes: ["Anime", "Scrabble", "Games"],
  });
});

router.get("/nameTemitayo", function (req, res, next) {
  res.render("viewtemitayo", {
    name: "Temitayo",
    quality: "Tall",
...
router.get("/namekupenya", function (req, res, next) {
  res.render("viewkupenya", {
    name: "Kupenya",
    quality: "tall",
    like: "Serenity",
    place: "Beach",
